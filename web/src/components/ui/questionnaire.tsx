...
function QuestionnaireProgress({
  ...
  return (
    <QuestionnairePrimitive.Progress
      ...
      className={cn(
        "min-h-lh w-fit min-w-max text-xs font-medium text-muted-foreground tabular-nums",
        className,
      )}
      {...props}
    />
  ...
  return (
    ...
    >
      <QuestionnairePrimitive.Input
        ...
        className={cn(
          "h-8 min-h-11 w-full min-w-0 rounded-lg border border-input bg-transparent px-2.5 py-1 text-base transition outline-none focus-visible:border-ring focus-visible:ring-3 focus-visible:ring-ring/50 disabled:pointer-events-none disabled:cursor-not-allowed disabled:bg-input/50 disabled:opacity-50 aria-invalid:border-destructive aria-invalid:ring-3 aria-invalid:ring-destructive/20 sm:min-h-0 md:text-sm dark:bg-input/30 disabled:dark:bg-input/80 dark:aria-invalid:border-destructive/50 dark:aria-invalid:ring-destructive/40",
...
function QuestionnaireActions({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
      ...
      className={cn("grid min-h-11 w-full grid-cols-3 items-center gap-2 sm:min-h-8", className)}
      {...props}
    />
  );
}
