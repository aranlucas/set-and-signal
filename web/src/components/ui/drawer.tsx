    ...
    <DrawerPortal data-slot="drawer-portal">
      ...
      >
        <DrawerPrimitive.Popup
          ...
          className={cn(
            // Base.
            "group/drawer-popup pointer-events-auto fixed z-50 m-0 flex h-auto max-h-full min-h-0 w-full transform flex-col bg-popover text-sm text-popover-foreground transition duration-300 ease-out will-change-transform outline-none select-none data-[swipe-direction=down]:rounded-t-xl data-[swipe-direction=down]:border-t data-[swipe-direction=left]:rounded-r-xl data-[swipe-direction=left]:border-r data-[swipe-direction=right]:rounded-l-xl data-[swipe-direction=right]:border-l data-[swipe-direction=up]:rounded-b-xl data-[swipe-direction=up]:border-b",
            // Nested.
            "data-nested-drawer-open:overflow-hidden data-nested-drawer-open:brightness-95",
            // Bleed.
            "after:pointer-events-none after:absolute after:bg-popover data-[swipe-axis=x]:after:inset-y-0 data-[swipe-axis=x]:after:w-full data-[swipe-axis=y]:after:inset-x-0 data-[swipe-axis=y]:after:h-full data-[swipe-direction=down]:after:top-full data-[swipe-direction=left]:after:right-full data-[swipe-direction=right]:after:left-full data-[swipe-direction=up]:after:bottom-full",
            // Sizing.
            "data-[swipe-axis=y]:max-h-full sm:data-[swipe-axis=x]:max-w-sm",
            // Stack.
            "",
            // Transitions.
            "data-ending-style:opacity-100 data-nested-drawer-swiping:duration-0 data-starting-style:opacity-0 data-swiping:duration-0",
            // Axis: y.
            "data-[swipe-axis=y]:inset-x-0 data-[swipe-axis=y]:data-nested-drawer-open:h-full",
            // Axis: x.
        ...
        >
          ...
          <DrawerPrimitive.Content
            ...
            className={cn(
              "flex min-h-0 flex-1 flex-col overflow-hidden overscroll-contain rounded-lg transition-opacity duration-300 ease-out select-text group-data-nested-drawer-open/drawer-popup:opacity-0 group-data-nested-drawer-swiping/drawer-popup:opacity-100 group-data-swiping/drawer-popup:select-none",
            )}
          >
            {children}
          </DrawerPrimitive.Content>
