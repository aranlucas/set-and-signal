...
import { MUSCLES, INERT, levelsOf } from "../lib/muscles";
import type { MuscleSlug } from "../lib/muscles";
import type { Body } from "../lib/types";
import type { BodyPaths } from "../lib/body-paths";
...
function useBodyPaths(): BodyPaths | null {
  ...
  useEffect(() => {
    ...
    bodyPathsPromise =
      bodyPathsPromise ||
      import("../lib/body-paths").then((module) => (cachedBodyPaths = module.default));
    bodyPathsPromise
      .then((loadedPaths) => {
