...
import { useDateLabels } from "../hooks/use-date-labels";
import { useEffortLabels } from "../hooks/use-effort-labels";
import { useExerciseMetadataLabels } from "../hooks/use-exercise-metadata-labels";
import { useNavigate } from "@tanstack/react-router";
import { useStore } from "../store/useStore";
import { useWorkoutTimer } from "../store/useWorkoutTimer";
import { exOr, isBarbellEq } from "../lib/exercises";
import {
  effectiveRoutine,
  lastEntryFor,
  bestWeightFor,
...
import { fmtNum, fmtDate, todayISO, exCount } from "../lib/format";
import { beep, vibrate } from "../lib/sound";
import { api } from "../lib/api";
import Media from "../components/Media";
import { beginWorkout, completeWorkout } from "../sheets/workout-actions";
...
import { barWeightFor } from "../lib/plates";
import { glyphOf } from "../lib/glyphs";
import type { AppState, EffortKind, LoggedSet, ActiveWorkout } from "../lib/types";
...
import type { CustomEx, SheetClose, Id } from "../lib/types";
import type { SheetEx } from "../sheets/shared";
import type { FinishSummaryPayload } from "../sheets/workout-actions";
import type { SetWorkoutSheet, WorkoutSheetState } from "../sheets/workout-state";
import { removeCustomExercise } from "../sheets/custom-delete";
import { ExercisePicker, AddToRoutine } from "../sheets/picker";
import { ExConfigSheet } from "../sheets/config";
import { ExerciseDetail } from "../sheets/detail";
import { CustomExerciseForm } from "../sheets/custom";
import { FinishSummary, TopWeight, WorkoutComplete } from "../sheets/workout";

const translatedReason = (
  t: TFunction,
  why: NonNullable<import("../lib/types").Prescription["why"]>,
