...
func TestProgramToolsSanitizeDiffAndPreserveState(t *testing.T) {
	...
	input := MCPSetProgramInput{
		Routines: []MCPRoutineInput{{ID: &id, Name: "New", Ex: []MCPExConfigInput{{ID: "bench", Sets: floatPtr(3), Reps: floatPtr(5), Weight: floatPtr(60)}}}},
		Week:     map[string]*string{"2": &id, "6": stringPtr("ghost")},
	}
