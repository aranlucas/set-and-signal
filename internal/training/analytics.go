...
// Estimate1RM applies the same estimators as web/src/domain/training/onerm.ts. The bool
...
// NextProgression ports the policy decision in web/src/domain/training/progression.ts.
